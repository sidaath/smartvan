...
public class ViewStudentBackgroundWorker extends AsyncTask<String,Child,Void> {
    String json_string="http://10.0.2.2/smartvan/viewStudent.php";
    Context context;
    Activity activity;
    String van_id;
    ...
    ViewStudentBackgroundWorker(Context ctx, String vanId){
        context=ctx;
    ...
    protected Void doInBackground(String... params) {
        try {
            ...
            String post_data= URLEncoder.encode("vanId","UTF-8")+"="+URLEncoder.encode(van_id,"UTF-8");
    ...
    protected void onPreExecute() {
        recyclerView=(RecyclerView)activity.findViewById(R.id.studentRecyclerview);
